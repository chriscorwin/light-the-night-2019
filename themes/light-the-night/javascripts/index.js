...
console.log(`citiesDescendingOrder: `, citiesDescendingOrder);

const cityNameGoldTspan = document.querySelector( '#dyn-data___city-name--gold tspan' );
const cityNameGoldTspanBBox = cityNameGoldTspan.getBBox();
const cityNameGoldTspanBBoxWidth = cityNameGoldTspanBBox.width;
const cityNameGoldTspanBBoxHeight = cityNameGoldTspanBBox.height;
console.log(`cityNameGoldTspanBBoxWidth: `, cityNameGoldTspanBBoxWidth);
console.log(`cityNameGoldTspanBBoxHeight: `, cityNameGoldTspanBBoxHeight);
cityNameGoldTspan.textContent = citiesDescendingOrder[0].city;

const stateNameGoldTspan = document.querySelector( '#dyn-data___state-name--gold tspan' );
const stateNameGoldTspanBBox = stateNameGoldTspan.getBBox();
const stateNameGoldTspanBBoxWidth = stateNameGoldTspanBBox.width;
const stateNameGoldTspanBBoxHeight = stateNameGoldTspanBBox.height;
console.log(`stateNameGoldTspanBBoxWidth: `, stateNameGoldTspanBBoxWidth);
console.log(`stateNameGoldTspanBBoxHeight: `, stateNameGoldTspanBBoxHeight);
stateNameGoldTspan.textContent = citiesDescendingOrder[0].state;

const amountRaisedGoldTspan = document.querySelector( '#dyn-data___amount-raised--gold tspan' );
const amountRaisedGoldTspanBBox = amountRaisedGoldTspan.getBBox();
const amountRaisedGoldTspanBBoxWidth = amountRaisedGoldTspanBBox.width;
const amountRaisedGoldTspanBBoxHeight = amountRaisedGoldTspanBBox.height;
console.log(`amountRaisedGoldTspanBBoxWidth: `, amountRaisedGoldTspanBBoxWidth);
console.log(`amountRaisedGoldTspanBBoxHeight: `, amountRaisedGoldTspanBBoxHeight);

const firstPlaceCityAmount = Math.floor(citiesDescendingOrder[0].amount);
...
const cityNameSilverTspan = document.querySelector( '#dyn-data___city-name--silver tspan' );
const cityNameSilverTspanBBox = cityNameSilverTspan.getBBox();
const cityNameSilverTspanBBoxWidth = cityNameSilverTspanBBox.width;
const cityNameSilverTspanBBoxHeight = cityNameSilverTspanBBox.height;
console.log(`cityNameSilverTspanBBoxWidth: `, cityNameSilverTspanBBoxWidth);
console.log(`cityNameSilverTspanBBoxHeight: `, cityNameSilverTspanBBoxHeight);
cityNameSilverTspan.textContent = citiesDescendingOrder[1].city;

const stateNameSilverTspan = document.querySelector( '#dyn-data___state-name--silver tspan' );
const stateNameSilverTspanBBox = stateNameSilverTspan.getBBox();
const stateNameSilverTspanBBoxWidth = stateNameSilverTspanBBox.width;
const stateNameSilverTspanBBoxHeight = stateNameSilverTspanBBox.height;
console.log(`stateNameSilverTspanBBoxWidth: `, stateNameSilverTspanBBoxWidth);
console.log(`stateNameSilverTspanBBoxHeight: `, stateNameSilverTspanBBoxHeight);
stateNameSilverTspan.textContent = citiesDescendingOrder[1].state;

const amountRaisedSilverTspan = document.querySelector( '#dyn-data___amount-raised--silver tspan' );
const amountRaisedSilverTspanBBox = amountRaisedSilverTspan.getBBox();
const amountRaisedSilverTspanBBoxWidth = amountRaisedSilverTspanBBox.width;
const amountRaisedSilverTspanBBoxHeight = amountRaisedSilverTspanBBox.height;
console.log(`amountRaisedSilverTspanBBoxWidth: `, amountRaisedSilverTspanBBoxWidth);
console.log(`amountRaisedSilverTspanBBoxHeight: `, amountRaisedSilverTspanBBoxHeight);

const secondPlaceCityAmount = Math.floor(citiesDescendingOrder[1].amount);

console.log(`typeof secondPlaceCityAmount: `, typeof secondPlaceCityAmount);

amountRaisedSilverTspan.textContent = '$' + formatMoney(secondPlaceCityAmount);
...
const cityNameBronzeTspan = document.querySelector( '#dyn-data___city-name--bronze tspan' );
const cityNameBronzeTspanBBox = cityNameBronzeTspan.getBBox();
const cityNameBronzeTspanBBoxWidth = cityNameBronzeTspanBBox.width;
const cityNameBronzeTspanBBoxHeight = cityNameBronzeTspanBBox.height;
console.log(`cityNameBronzeTspanBBoxWidth: `, cityNameBronzeTspanBBoxWidth);
console.log(`cityNameBronzeTspanBBoxHeight: `, cityNameBronzeTspanBBoxHeight);
cityNameBronzeTspan.textContent = citiesDescendingOrder[2].city;

const stateNameBronzeTspan = document.querySelector( '#dyn-data___state-name--bronze tspan' );
const stateNameBronzeTspanBBox = stateNameBronzeTspan.getBBox();
const stateNameBronzeTspanBBoxWidth = stateNameBronzeTspanBBox.width;
const stateNameBronzeTspanBBoxHeight = stateNameBronzeTspanBBox.height;
console.log(`stateNameBronzeTspanBBoxWidth: `, stateNameBronzeTspanBBoxWidth);
console.log(`stateNameBronzeTspanBBoxHeight: `, stateNameBronzeTspanBBoxHeight);
stateNameBronzeTspan.textContent = citiesDescendingOrder[2].state;

const amountRaisedBronzeTspan = document.querySelector( '#dyn-data___amount-raised--bronze tspan' );
const amountRaisedBronzeTspanBBox = amountRaisedBronzeTspan.getBBox();
const amountRaisedBronzeTspanBBoxWidth = amountRaisedBronzeTspanBBox.width;
const amountRaisedBronzeTspanBBoxHeight = amountRaisedBronzeTspanBBox.height;
console.log(`amountRaisedBronzeTspanBBoxWidth: `, amountRaisedBronzeTspanBBoxWidth);
console.log(`amountRaisedBronzeTspanBBoxHeight: `, amountRaisedBronzeTspanBBoxHeight);

const thirdPlaceCityAmount = Math.floor(citiesDescendingOrder[2].amount);
